...
if ( GetFlag(&quot;todd_project_fertility_upgrade&quot;) == 1 &amp;&amp; GetTextFlag(&quot;todd_current_proxy&quot;) == cuid ) {
    ...
    if ( emb &lt; 1 &amp;&amp; (sex == 2 || sex == 3) ) {
        result = true;
    }
}

if (GetPerFlag(&quot;todd_scan_fert_before&quot;) == 1 ) {
 result = false;
}

result;</conditions>
  <text>- There, I got the scan results for before the pregnancy.

&lt;% SetPerFlag(&quot;todd_scan_fert_before&quot;, 1); &quot;&quot;;%&gt;</text>
  <priority>1</priority>
